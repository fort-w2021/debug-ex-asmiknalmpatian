...
```{r, a}
# Ausloeser des Fehlers: fbag() Funktion, die in Funktion fboxplot() aufgerufen wird. 
# Ursache des Fehlers: das Fehlen der Spaltennamen von y in Funktion legend, innerhalb der Funktion fbag()
...
# Moeglichkeit 1: 
# Argument plotlegend = FALSE setzen (trotzdem Warnmeldung)

# Moeglichkeit 2: 
# Inputchecks, die NULL colnames fuer y verhindern sollen
